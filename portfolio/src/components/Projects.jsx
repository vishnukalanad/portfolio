                ...
                <li className="mb-10 ms-6">
                    ...
                    <p className="text-xs mt-1 text-slate-500"> July 2024 - August 2025</p>
                    {
                        ProjectsData.map((project, index) => {
                            return <ProjectDetails className={"mt-3"} title={project.name} description={project.description} clients={project.clients} stack={project.stack} keyPoints={project.keyPoints} key={index}/>
                        })
                    }
                    {/*<p className="text-xs text-stone-500"><span className="font-medium">Digiledge</span> (A Montoak Company)</p>*/}
                </li>
            </ol>
        </Card>
    </div>
